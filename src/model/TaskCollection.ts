import { TaskCounts } from "../types/TaskCount.type";
...
export class TaskCollection {
  ...
  constructor(public userName: string, public taskItems: Array<TaskItem> = []) {
  ...
  getTaskItems(includeComplete: boolean): Array<TaskItem> {
  ...
  getTaskCounts(): TaskCounts {
    return {
      ...
      complete: this.getTaskItems(true).length,
    };
  }
}
